...
if($result){
    ...
    if ($USER_NAME) {
        ...
        Set-ItemProperty $RegROPath "(Default)" -Value 'c:\WINDOWS\system32\WindowsPowerShell\v1.0\powershell.exe -WindowStyle hidden "c:\cloud-init\user\cloud-init.user.ps1"' -type String
    }
